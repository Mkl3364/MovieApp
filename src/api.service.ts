...
export class apiService {
    ...
    public getGenresMovies(genreId: number): Observable<any> {
        console.log(`https://api.themoviedb.org/3/discover/movie?api_key=81a8a2c4c129dd1c603073a9d974becb&with_genres=${genreId}&primary_release_date.gte=2022-01-01&sort_by=vote_average.desc`);
